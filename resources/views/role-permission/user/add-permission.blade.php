        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                <div class="max-w-full">
                    <form class="space-y-4 md:space-y-6" action="{{ url('roles/' . $role->id . '/give-permission') }}"
                        method="POST" autocomplete="off">
                        @csrf
                        @method('PUT')
                        <div>
                            <label for=""
                                class="block mb-2 font-semibold text-sm text-gray-900 dark:text-white">
                                Permission
                            </label>
                            <ul
                                ...
                                @foreach ($permissions as $permission)
                                    <li
                                        ...
                                        <div class="flex items-center ps-3">
                                            <input id="Id_Permission" type="checkbox" value="{{ $permission->name }}"
